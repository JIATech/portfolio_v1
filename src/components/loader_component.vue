<template>
  <div ref="loader1" :class="loaderClass1"></div>
  <div ref="loader2" :class="loaderClass2"></div>
</template>
...
export default {
  ...
  methods: {
    selectAnimation() {
      const animations = ["expandBar", "expandDot"];
    ...
    expandDot() {
      ...
      const maxScale = Math.max(window.innerWidth, window.innerHeight) * 1.5;
      const interval = 1; // Intervalo en milisegundos para el incremento de la escala
